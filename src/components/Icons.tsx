 ...
 * SVG Icons Component
 *
 * Custom icons for the app - no external icon library needed
 */
...
export const SyringeIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
  ...
  >
    <path d="M18 2l4 4" />
    <path d="M17 7l3-3" />
    <path d="M19 9l-7 7-4-4 7-7" />
    <path d="M8 12l-4 4-2 6 6-2 4-4" />
    <path d="M4 16l2 2" />
  </svg>
);
...
export const DogIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    ...
    className={className}
  >
    <path d="M18 4c-1 0-2 1-2 1l-1 2H9L8 5S7 4 6 4 4 5 4 6v5c0 2 2 4 4 4v4c0 1 1 2 2 2h4c1 0 2-1 2-2v-4c2 0 4-2 4-4V6c0-1-1-2-2-2zM8 9a1 1 0 110-2 1 1 0 010 2zm8 0a1 1 0 110-2 1 1 0 010 2z" />
  </svg>
);
...
export const CatIcon: React.FC<IconProps> = ({ className = '', size = 24 }) => (
  <svg
    ...
    className={className}
  >
    <path d="M12 2C9 2 7 4 7 4L6 8H5c-1 0-2 1-2 2v2c0 1 .5 2 1 2v5c0 1.5 1.5 3 3 3h10c1.5 0 3-1.5 3-3v-5c.5 0 1-1 1-2v-2c0-1-1-2-2-2h-1l-1-4s-2-2-5-2zm-3 9a1 1 0 110-2 1 1 0 010 2zm6 0a1 1 0 110-2 1 1 0 010 2zm-3 4l-1.5-1h3L12 15z" />
  </svg>
);
